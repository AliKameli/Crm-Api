...
namespace CRCIS.Web.INoor.CRM.Domain.Reports.AdminCardboard.Queries
{
    public class AdminCardboardReportQuery : AbstractDataTableQuery
    {
        ...
        public AdminCardboardReportQuery(int pageIndex, int pageSize,
